...
Status is a command that is safe to use at any time. If you want to see what's going on it's good to use `git status` in between commands until you get to know the flow better.
```
git add .
git status
